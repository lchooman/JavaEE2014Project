...
public interface ICustomerDAO {
    ...
    CustomerDB getUserbyEmailId(String emailId);

    @Transactional(value="txManager", propagation=Propagation.MANDATORY)
    Status saveUser(Integer[] id, String longName, String password, String emailId, String contactNumber, String address);
}
