...
public interface IShowBookingDAO {

    @Transactional(value="txManager", propagation=Propagation.MANDATORY)
    ShowBookingDB saveShowBooking(MovieShowDB movieShow, Date dateBooked, Integer seatsBooked, String cardNumber, CustomerDB customer, int refNum);
}
